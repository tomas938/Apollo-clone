export const state = () => ({
  ...
  others: V prípade, že ste učastníkom konferencie, oslavy, svadby alebo inej udalosti v hotelových priestoroch, informujte sa prosím o možnostiach parkovania u organizátora podujatia.'
})
