export const state = () => ({
  ...
  parking: {
    ...
    restrictions: 'Voľný prejazd nie je povolený. V prípade, ak ste priviezli alebo prišli vyzdvihnúť hotelových zákazníkov, lístok Vám do 15 min. zdarma odblokujú na recepcii.
